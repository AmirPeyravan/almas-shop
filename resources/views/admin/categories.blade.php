            ...
            <div class="content-card-body">
                ...
                <form id="addCategoryForm">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="categoryName" placeholder="مثال: الکترونیک" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control form-control-textarea" id="categoryDescription" placeholder="توضیحات دسته‌بندی (اختیاری)"></textarea>
                    </div>
